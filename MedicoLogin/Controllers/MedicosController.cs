...
namespace MedicoLogin.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MedicoID,EspecialidadeID,CidadeID,CRM,Nome,Endereco,Email,Convenio,Clinica")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MedicoID,EspecialidadeID,CidadeID,CRM,Nome,Endereco,Email,Convenio,Clinica")] Medico medico)
        {
            if (ModelState.IsValid)
            {
